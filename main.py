...
def attack(char_name: str, char_class: str) -> str:
    """Print level of damage according to type of player."""
...
def defence(char_name: str, char_class: str) -> str:
    """Print level of defence according to type of player."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не блокировал ед. урона')


def special(char_name: str, char_class: str) -> str:
    """Print type of super power according to type of player."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Start of training and choosing type of training."""
    if char_class == 'warrior':
...
def main() -> str:
    """Begin the game and choose name."""
